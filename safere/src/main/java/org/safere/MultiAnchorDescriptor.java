...
record MultiAnchorDescriptor(
  ...
  sealed interface StartPlan {
    ...
    @SuppressWarnings("ArrayRecordComponent")
    record MultiLiteral(
        String[] literals, CharClassScanInfo fallbackClass, WuManberModel wuManberModel)
        implements StartPlan {
      MultiLiteral(String[] literals, CharClassScanInfo fallbackClass) {
        this(literals, fallbackClass, null);
      }
